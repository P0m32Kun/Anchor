...
- [`0008-remove-claude-entrypoint.md`](0008-remove-claude-entrypoint.md): keep `AGENTS.md` as the sole repository Agent contract and remove the Claude-specific pointer.
