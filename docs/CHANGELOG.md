...
- **删除重复文件**：`AGENTS.md` 与 `CLAUDE.md` 完全重复，已删除
- **CLAUDE.md 增强**：添加项目约定（工作语言、验证要求、配置单位、文档入口）
- **architecture.md 更新**：`last_updated` 从 2026-05-07 更新到 2026-05-13
- **审计报告入库**：`docs/current/audit-reports/` 4 个阶段报告 + `code-health-audit.md` 加入 git
