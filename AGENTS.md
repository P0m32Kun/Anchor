...
This project is indexed by GitNexus as **Anchor** (5375 symbols, 8973 relationships, 275 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| End-of-session docs & memory cleanup | `.claude/skills/neat-freak/SKILL.md` |
